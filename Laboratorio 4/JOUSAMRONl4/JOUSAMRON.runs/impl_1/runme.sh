...
HD_PWD='C:/Users/electronica/JOUSAMRON/JOUSAMRON.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Compuerta1JOUSAMRON.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Compuerta1JOUSAMRON.tcl -notrace
