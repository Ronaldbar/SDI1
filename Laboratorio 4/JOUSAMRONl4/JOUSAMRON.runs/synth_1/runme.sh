...
HD_PWD='C:/Users/electronica/JOUSAMRON/JOUSAMRON.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Compuerta1JOUSAMRON.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Compuerta1JOUSAMRON.tcl
